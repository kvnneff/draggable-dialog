...
this.draggable.on("end",function(){a.emit("end")});this.draggable.build()};d.prototype.show=function(){document.body.appendChild(this.docFragment);c(this.nodes.containerDiv).remove("DraggableDialog--hidden");this.active();this.emit("show")};d.prototype.hide=function(){c(this.nodes.containerDiv).add("DraggableDialog--hidden");this.emit("hide")};d.prototype.remove=function(){this.draggable&&this.draggable.destroy();this.nodes.titleClose.removeEventListener("click",k.bind(self),!1);this.nodes.containerDiv.parentNode.removeChild(this.nodes.containerDiv);
this.emit("remove")};d.prototype.onmousedown=function(){this.active();this.emit("click")};d.prototype.addClass=function(a){c(this.nodes.containerDiv).add(a)};d.prototype.active=function(){var a=document.getElementsByClassName("DraggableDialog"),b=[],b=Array.prototype.slice.call(a);for(i=b.length;i--;)b[i].style.zIndex=999,c(b[i]).add("DraggableDialog--inactive");c(this.nodes.containerDiv).remove("DraggableDialog--inactive").add("DraggableDialog--active");this.nodes.containerDiv.style.zIndex=1E3};
e.exports=function(a,b){return new d(a,b)}});"object"==typeof exports?module.exports=b("draggable-dialog"):"function"==typeof define&&define.amd?define([],function(){return b("draggable-dialog")}):this.draggableDialog=b("draggable-dialog")})();
