...
b.oMatchesSelector;e.exports=function(b,d){if(!b||1!==b.nodeType)return!1;if(f)return f.call(b,d);for(var c=a.all(d,b.parentNode),l=0;l<c.length;++l)if(c[l]==b)return!0;return!1}});c.register("component~closest@0.1.4",function(h,e){var a=c("component~matches-selector@0.1.5");e.exports=function(b,c,e,d){b=e?{parentNode:b}:b;for(d=d||document;(b=b.parentNode)&&b!==document;){if(a(b,c))return b;if(b===d)break}}});c.register("component~delegate@0.2.3",function(h,e){var a=c("component~closest@0.1.4"),
b=c("component~event@0.1.4");h.bind=function(c,e,d,k,l){return b.bind(c,d,function(d){d.delegateTarget=a(d.target||d.srcElement,e,!0,c);d.delegateTarget&&k.call(c,d)},l)};h.unbind=function(a,c,d,e){b.unbind(a,c,d,e)}});c.register("component~events@1.0.9",function(h,e){function a(d,b){if(!(this instanceof a))return new a(d,b);if(!d)throw Error("element required");if(!b)throw Error("object required");this.el=d;this.obj=b;this._events={}}function b(a){a=a.split(/ +/);return{name:a.shift(),selector:a.join(" ")}}
var f=c("component~event@0.1.4"),g=c("component~delegate@0.2.3");e.exports=a;a.prototype.sub=function(a,b,c){this._events[a]=this._events[a]||{};this._events[a][b]=c};a.prototype.bind=function(a,c){function l(){var a=[].slice.call(arguments).concat(p);n[c].apply(n,a)}var e=b(a),h=this.el,n=this.obj,m=e.name;c=c||"on"+m;var p=[].slice.call(arguments,2);e.selector?l=g.bind(h,e.selector,m,l):f.bind(h,m,l);this.sub(m,c,l);return l};a.prototype.unbind=function(a,b){if(0==arguments.length)return this.unbindAll();
if(1==arguments.length)return this.unbindAllOf(a);var c=this._events[a];c&&(c=c[b])&&f.unbind(this.el,a,c)};a.prototype.unbindAll=function(){for(var a in this._events)this.unbindAllOf(a)};a.prototype.unbindAllOf=function(a){var b=this._events[a];if(b)for(var c in b)this.unbind(a,c)}});c.register("component~transform-property@0.0.1",function(c,e){for(var a=["webkitTransform","MozTransform","msTransform","OTransform","transform"],b=document.createElement("p"),f,g=0;g<a.length;g++)if(f=a[g],null!=b.style[f]){e.exports=
f;break}});c.register("component~has-translate3d@0.0.3",function(h,e){var a=c("component~transform-property@0.0.1");if(a&&window.getComputedStyle){var b=document.createElement("div");b.style[a]="translate3d(1px,1px,1px)";document.body.insertBefore(b,null);a=getComputedStyle(b).getPropertyValue({webkitTransform:"-webkit-transform",OTransform:"-o-transform",msTransform:"-ms-transform",MozTransform:"-moz-transform",transform:"transform"}[a]);document.body.removeChild(b);e.exports=null!=a&&a.length&&
"none"!=a}else e.exports=!1});c.register("component~translate@0.1.0",function(h,e){var a=c("component~transform-property@0.0.1"),b=c("component~has-translate3d@0.0.3"),f=/%$/;e.exports=function(c,d,e){f.test(d)||(d+="px");f.test(e)||(e+="px");a?c.style[a]=b?"translate3d("+d+", "+e+", 0)":"translate("+d+","+e+")":(c.style.left=d,c.style.top=e)}});c.register("ui-component~draggable@HEAD",function(h,e){function a(a,b){this._yAxis=this._xAxis=!0;this.el=a;this.options={};this.options.roundPixels=!0;"undefined"!==
typeof b.roundPixels&&(this.options.roundPixels=b.roundPixels)}var b=c("component~emitter@1.1.3"),f=c("ui-component~mouse@0.0.1"),g=c("component~events@1.0.9"),d=c("component~translate@0.1.0"),k=c("component~classes@1.2.1");e.exports=function(b,c){c=c||{};return new a(b,c)};b(a.prototype);a.prototype.build=function(){var a=this._handle||this.el;this.touch=g(a,this);this.touch.bind("touchstart","onmousedown");this.touch.bind("touchmove","onmousemove");this.touch.bind("touchend","onmouseup");this.mouse=
f(a,this);this.mouse.bind();return this};a.prototype.onmousedown=function(a){a.preventDefault();a.touches&&(a=a.touches[0]);var b=this.rect=this.el.getBoundingClientRect();this.ox=b.left-this.el.offsetLeft;this.oy=b.top-this.el.offsetTop;this.x=a.pageX-b.left;this.y=a.pageY-b.top;k(this.el).add("dragging");this.emit("start")};a.prototype.onmousemove=function(a){var b,c,e,f,g;a.touches&&(a=a.touches[0]);var h=this._xAxis?a.pageX-this.el.offsetLeft-this.x:this.ox,k=this._yAxis?a.pageY-this.el.offsetTop-
this.y:this.oy;g=this.el;if(e=this._containment)a=k+g.clientHeight,b=h+g.clientWidth,c=e.clientHeight,e=e.clientWidth,f=c-g.clientHeight,g=e-g.clientWidth,0>=h&&(h=0),0>=k&&(k=0),a>=c&&(k=f),b>=e&&(h=g);!0===this.options.roundPixels&&(h=Math.floor(h),k=Math.floor(k));d(this.el,h,k);this.emit("drag")};a.prototype.onmouseup=function(a){k(this.el).remove("dragging");this.emit("end")};a.prototype.destroy=function(){this.mouse&&this.mouse.unbind();this.mouse=null;this.touch&&this.touch.unbind();this.touch=
null;return this};a.prototype.disableXAxis=function(){this._xAxis=!1;return this};a.prototype.disableYAxis=function(){this._yAxis=!1;return this};a.prototype.containment=function(a){this._containment=a;return this};a.prototype.handle=function(a){this._handle=a;return this}});c.register("draggable-dialog",function(h,e){var a=c("component~emitter@1.1.3"),b=c("component~classes@1.2.1"),f=c("ui-component~draggable@HEAD"),g=c("ui-component~mouse@0.0.1"),d,k;k=function(){this.hide()};d=function(a,c){this.options=
c||{};this.nodes={};this.el=a;this.el.tagName&&b(a).add("DraggableDialog--hidden");this.render()};a(d.prototype);d.prototype.render=function(){var a=this;this.docFragment=document.createDocumentFragment();this.nodes.containerDiv=document.createElement("div");this.nodes.titleClose=document.createElement("a");this.nodes.titleDiv=this.nodes.containerDiv.cloneNode();this.nodes.contentDiv=this.nodes.containerDiv.cloneNode();this.nodes.titleClose.innerHTML="&times;<em>close</em>";"string"===typeof this.el?
...
this.docFragment.appendChild(this.nodes.containerDiv);b(this.nodes.containerDiv).add("DraggableDialog").add("DraggableDialog--hidden");b(this.nodes.titleDiv).add("DraggableDialog-titleBar");b(this.nodes.titleClose).add("DraggableDialog-closeButton");b(this.nodes.contentDiv).add("DraggableDialog-content");this.nodes.titleClose.addEventListener("click",k.bind(a),!1);this.mouse=g(this.nodes.containerDiv,this);this.mouse.bind();this.draggable=f(this.nodes.containerDiv);this.options.title&&this.draggable.handle(this.nodes.titleDiv);
this.draggable.on("drag",function(){a.emit("drag")});this.draggable.on("start",function(){a.emit("start")});this.draggable.on("end",function(){a.emit("end")});this.draggable.build()};d.prototype.show=function(){document.body.appendChild(this.docFragment);b(this.nodes.containerDiv).remove("DraggableDialog--hidden");this.active();this.emit("show")};d.prototype.hide=function(){b(this.nodes.containerDiv).add("DraggableDialog--hidden");this.emit("hide")};d.prototype.remove=function(){this.draggable&&this.draggable.destroy();
this.nodes.titleClose.removeEventListener("click",k.bind(self),!1);this.nodes.containerDiv.parentNode.removeChild(this.nodes.containerDiv);this.emit("remove")};d.prototype.onmousedown=function(){this.active();this.emit("click")};d.prototype.addClass=function(a){b(this.nodes.containerDiv).add(a)};d.prototype.active=function(){var a=document.getElementsByClassName("DraggableDialog"),c=[],c=Array.prototype.slice.call(a);for(i=c.length;i--;)b(c[i]).add("DraggableDialog--inactive");b(this.nodes.containerDiv).remove("DraggableDialog--inactive").add("DraggableDialog--active")};
e.exports=function(a,b){return new d(a,b)}});"object"==typeof exports?module.exports=c("draggable-dialog"):"function"==typeof define&&define.amd?define([],function(){return c("draggable-dialog")}):this.draggableDialog=c("draggable-dialog")})();
