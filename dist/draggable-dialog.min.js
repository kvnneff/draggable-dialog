...
this.emit("remove")};d.prototype.onmousedown=function(){var a=document.getElementsByClassName("DraggableDialog"),b=[],b=Array.prototype.slice.call(a);for(i=b.length;i--;)b[i].style.zIndex=999,c(b[i]).add("DraggableDialog--inactive");c(this.nodes.containerDiv).remove("DraggableDialog--inactive").add("DraggableDialog--active");this.nodes.containerDiv.style.zIndex=1E3;this.emit("click")};d.prototype.addClass=function(a){c(this.nodes.containerDiv).add(a)};e.exports=function(a,b){return new d(a,b)}});
"object"==typeof exports?module.exports=b("draggable-dialog"):"function"==typeof define&&define.amd?define([],function(){return b("draggable-dialog")}):this.draggableDialog=b("draggable-dialog")})();
